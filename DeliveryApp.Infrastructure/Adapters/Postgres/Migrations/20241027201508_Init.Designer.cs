...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Models.CourierAggregate.CourierStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Models.OrderAggregate.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Models.CourierAggregate.Courier", b =>
                {
                    b.HasOne("DeliveryApp.Core.Domain.Models.CourierAggregate.CourierStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Models.OrderAggregate.Order", b =>
                {
                    b.HasOne("DeliveryApp.Core.Domain.Models.OrderAggregate.OrderStatus", "Status")
                        .WithMany()
                        .HasForeignKey("status_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("DeliveryApp.Core.Domain.SharedKernel.Location", "TargetLocation", b1 =>
                        {
                            ...
                            b1.Property<int>("X")
                                .HasColumnType("integer")
                                .HasColumnName("target_location_x");

                            b1.Property<int>("Y")
                                .HasColumnType("integer")
                                .HasColumnName("target_location_y");
